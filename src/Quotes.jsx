...
const Quote = () => {
  return (
    <div className="flex -mb-40 items-center justify-center">
      <div className="bg-[#C4C4C426]/15 p-5 md:p-4 lg:p-3 w-[80%] rounded-[50px]">
        <div className="bg-[#17C2EC] px-6 py-7 lg:py-14 flex flex-col gap-8 justify-center items-center rounded-[50px]" >
